...
firm_code={'samsung':'%BB%EF%BC%BA%C0%FC%C0%DA','lg':'lg%C0%FC%C0%DA','hyundai':'%C7%F6%B4%EB%C0%DA%B5%BF%C2%F7','sk':'sk%C7%CF%C0%CC%B4%D0%BD%BA'}
his=[]
count_news={}
num_news=0
addr_format1='http://news.naver.com/main/search/search.nhn?query='
addr_format2='&st=news.all&q_enc=EUC-KR&r_enc=UTF-8&r_format=xml&rp=none&sm=title.basic&ic=all&so=datetime.dsc&stDate=range:19600101:'
addr_format3='&detail=1&pd=4&start=1&display=25&startDate=1960-01-01&endDate='
addr_format4='&page='
last_date=""
...
addr=addr_format1+firm_code[firm_name]+addr_format2+'20170521'+addr_format3+'2017-05-21'+addr_format4
crawler(addr)
fw.close()
